...
namespace MvcBasicApp.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Document,ProviderType,IsActive,Id")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Document,ProviderType,IsActive,Id")] Provider provider)
        {
            if (id != provider.Id)
            {
                return NotFound();
